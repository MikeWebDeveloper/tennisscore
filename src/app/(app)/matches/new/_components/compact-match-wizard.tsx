...
import { getAllPlayersForMatch } from "@/lib/actions/players-match-creation"
...
export function CompactMatchWizard({ players: initialPlayers, totalPlayerCount }: CompactMatchWizardProps) {
  ...
  const handleCreateMatch = async (finalDetailLevel: "points" | "simple" | "detailed" | "complex") => {
    ...
    try {
      ...
      const result = await createMatch(validatedData as any)
      ...
      case 2:
        return (
          <CompactPlayersStep
            ...
            onLoadAllPlayers={loadAllPlayers}
          />
        )
      case 3:
        return (
