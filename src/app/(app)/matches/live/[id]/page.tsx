...
import { LiveScoringSkeleton } from "./_components/live-scoring-skeleton"

// Lazy load the heavy LiveScoringInterface component
const LiveScoringInterface = dynamic(
  () => import("./_components/live-scoring-interface").then(mod => ({ 
    default: mod.LiveScoringInterface 
  })),
  { 
    loading: () => <LiveScoringSkeleton />
  }
)
