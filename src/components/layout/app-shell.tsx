...
import PWAOnboarding from "@/components/shared/pwa-onboarding"
import { initializeOfflineStorage } from "@/lib/utils/indexeddb-storage"
...
export function AppShell({ children, user }: AppShellProps) {
  ...
  const baseNavigation = [
    ...
    },
    {
      href: "/player-statistics",
      icon: BarChart3,
      label: t('playerStats') || 'Player Stats',
      description: t('playerMetrics') || 'Personal metrics'
    },
    {
      href: "/players",
      icon: Users,
  ...
  const localizedNavigation = isAdmin(user.email) 
    ? [...baseNavigation, {
        ...
        icon: Shield,
        label: "Admin",
        description: t('adminMenuDescription')
      }]
    : baseNavigation
            ...
            <div className="flex h-full flex-col">
              ...
              <div className="p-4 border-t border-border">
                <Button asChild className="w-full minimal-button font-medium shadow-sm">
                  <Link href="/matches/new" prefetch={true}>
